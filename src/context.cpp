...
LsContext::LsContext(const Hooks::DeviceInfo& info, VkSwapchainKHR swapchain,
    ...
    // 8-bit RGBA matches the typical Android swapchain bit-depth and is the
    // only 32-bit RGBA format AHardwareBuffer natively supports.
...
#ifdef __ANDROID__
    // Prime AHB images to GENERAL and release to VK_QUEUE_FAMILY_EXTERNAL so
    // framegen's first acquire has a matching release on the layer side.
    {
